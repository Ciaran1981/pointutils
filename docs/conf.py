...
# -*- coding: utf-8 -*-
#
# pointutils documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('..//pointutils'))
...
#html_static_path = ['_static'] # was causing issue
html_static_path = []
...
htmlhelp_basename = 'pointutilsdoc'
...
latex_documents = [
    (master_doc, 'pointutils.tex', 'pointutils Documentation',
     'Ciaran Robb', 'manual'),
]
